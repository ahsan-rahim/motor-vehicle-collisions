# -*- coding: utf-8 -*-
"""
Created on Sat Aug 22 20:15:23 2020
...
st.header("Where are the most number of people injured in an accident in NYC?")
injured_people = st.slider("Number of people injured in the vehicle collision" , 0 ,20)
st.map(data.query("number_of_persons_injured >= @injured_people ")[['latitude','longitude']].dropna(how="any"))


st.header("What time did the accidents occur?")
